/*
 * /derived/ from ex661, not setting up 'std' as the default namespace.
 *
 * (A similar example is provided for ODBC and DB2.)
 *
...
{ 
 otl_stream o(50, // buffer size 
              "insert into test_tab values(:f1<int>,:f2<char[8000]>) ",
                 // SQL statement
              db // connect object
             );
 char tmp[8001];
...
void select()
{ 
 db.set_max_long_size(8001); // set maximum long string size for connect object
