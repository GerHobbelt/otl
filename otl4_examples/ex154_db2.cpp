...
int main()
{
 ...
 try{
  ...
  db1.rlogon("UID=scott;PWD=tiger;DSN=db2sql"); // connect to DB2

  db2.rlogon("UID=scott;PWD=tiger;DSN=db2sql"); // connect to DB2
  db3.rlogon("UID=scott;PWD=tiger;DSN=db2sql"); // connect to DB2
 ...
 db1.logoff(); // disconnect from DB2
 db2.logoff(); // disconnect from DB2
 db3.logoff(); // disconnect from DB2
